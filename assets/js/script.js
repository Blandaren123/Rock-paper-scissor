...
function lose(user, comp) {
  ...
  userScore_span.innerHTML = userScore; 
  compScore_span.innerHTML = compScore;
  result_div.innerHTML = convertToWord(user) + " is vanquished by " + convertToWord(comp) + ". You Lose!!"; // this delivers the details to the dom, converting the resulting letter to a word 
